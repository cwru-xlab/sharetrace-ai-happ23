	...
	\begin{block}{4. Experimental Design}
	    ...
	    \begin{figure}
	    	...
	    	\subfloat[High school (Thiers13): 180 / 2,220]
	    		{\includegraphics[width=0.3\columnwidth]{anc/highschool12}} \qquad
			\subfloat[Workplace (InVS15): 217 / 4,274]
				{\includegraphics[width=0.3\columnwidth]{anc/workplace}} \qquad
			\subfloat[Scientific conf. (SFHH): 403 / 9,565]
				{\includegraphics[width=0.3\columnwidth]{anc/conference}}
